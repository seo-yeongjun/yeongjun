...
window.Typekit.config = {
    "a": "359713",
    "dl": "AAAAOgAAAAqUFa0vAgThMw",
    "fi": [10884, 10879, 10881, 175, 139],
    "fc": [{
        "id": 10884,
        "family": "ftnk",
        "src": "https://use.typekit.net/af/3593c9/000000000000000077586b59/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "stretch": "normal",
        ...
        "id": 10879,
        "family": "ftnk",
        "src": "https://use.typekit.net/af/28fd69/00000000000000007758da2b/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "500",
            "style": "normal",
            "stretch": "normal",
        ...
        "id": 10881,
        "family": "ftnk",
        "src": "https://use.typekit.net/af/afd07f/000000000000000077586b60/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "stretch": "normal",
    ...
    "fn": ["ftnk", ["n4", "n5", "n7"], "vcsm", ["n4", "n7"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.21.0",
    "kt": "359713_0b0f191e1a7c4bb0ca9f81694645aee9356262f5",
    "l": "typekit",
    "ps": 2,
...
/*{"k":"1.21.0","auto_updating":true,"last_published":"2017-11-16 20:02:14 UTC"}*/
;(function (window, document, undefined) {
    ...
    function da() {
        var a = [{name: "font-family", value: m.c[p + 1]}];
        this.g = [m.c[p]];
        this.b = a
    }
    ...
    function Ba(a, b, c) {
        ...
        if (!e && c) B(a.b); else {
            ...
            J(b, function (b) {
                ...
                S ? c = new Aa(h(a.i, a), h(a.j,
                    a), a.w, b, a.A, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u) : c = new va(h(a.i, a), h(a.j, a), a.w, b, a.A, d, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u);
                f.push(c)
            });
    ...
    T.prototype.load = function (a, b, c) {
        ...
        c = c || {};
        a = c.timeout;
        var e = !!c.async, f = na(), g = pa(this.o, f);
        c = new A(this.b, c, {
            active: function () {
                if (e) {
                    var a = K(g, f, d.i, !1);
    ...
    function Ga() {
        var a = m.ps, b = m.ht, c = Ha, d = m.a, e = m.kt, f = m.js, g = m.l;
        this.m = new G(m.ping);
        this.j = a;
        this.i = b;
        this.b = c || [];
